    ...
    public sealed partial class MediaPlayerPage : Page, IBarElementFactory
    {
        ...
        private void spectrum_Draw(object sender, AudioVisualizer.VisualizerDrawEventArgs args)
        {
            ...
            for (int index = 0; index < spectrumBarCount; index++)
            {
                ...
                drawingSession.FillRectangle(barX, (float)boundingRectTop.Bottom - spectrumBarHeight1, barSize.X, spectrumBarHeight1, Colors.Purple);
                drawingSession.FillRectangle(barX, (float)boundingRectBottom.Bottom - spectrumBarHeight2, barSize.X, spectrumBarHeight2, Colors.OrangeRed);
            }
            ...
            for (int index = 0; index < spectrumBarCount; index++)
            {
                ...
                if (index != 0)
                {
                    drawingSession.DrawLine(prevPointLeft, leftPoint, Colors.DarkBlue, 3);
                    drawingSession.DrawLine(prevPointRight, rightPoint, Colors.DarkGreen, 3);
                }
        ...
        private void PositionDisplay_Draw(object sender, VisualizerDrawEventArgs args)
        {
            ...
            ds.DrawText(timeString, 0, 0, Colors.DarkBlue);
        }
        ...
        public CompositionBrush CreateElementBrush(object sender, Color elementColor, Size size, Compositor compositor, CompositionGraphicsDevice device)
        {
            ...
            using (var drawingSession = CanvasComposition.CreateDrawingSession(surface))
            {
                ...
                drawingSession.FillCircle(center, radius, Color.FromArgb(255,0,0,0));
            }
